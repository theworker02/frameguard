...
<p align="center">
  ...
  Automated Flutter UI performance regression detection Ã¢â‚¬â€ budgets, baselines, and evidence-backed reports you can enforce in CI.
</p>
...
<p align="center">
  <a href="https://theworker02.github.io/frameguard/">Docs</a> Ã‚Â·
  <a href="https://pub.dev/packages/frameguard">pub.dev</a> Ã‚Â·
  <a href="doc/cli.md">CLI</a> Ã‚Â·
...
| **License** | MIT |
| **Telemetry** | None Ã¢â‚¬â€ local by default |
...
| Telemetry | N/A | **None** Ã¢â‚¬â€ local by default |
...
- **Capability model** Ã¢â‚¬â€ Unavailable beats fake zeros
...
Exit codes: `0` pass Ã‚Â· `1` regression Ã‚Â· `2` invalid config/report.
...
Full command map: [doc/cli.md](doc/cli.md) Ã‚Â· [docs/cli.html](https://theworker02.github.io/frameguard/cli.html).
...
Native extras (JankStats, signposts, GPU counters) are **Unavailable** until real adapters ship Ã¢â‚¬â€ we will not invent zeros. See `FrameGuard.capabilities` and platform adapters.
...
| [Diagnostics FG001Ã¢â‚¬â€œFG010](doc/diagnostics/) | What each finding means |
...
The example app includes intentional jank scenarios (rebuild storm, CPU stall, raster stress, Ã¢â‚¬Â¦) so you can validate FrameGuard against known behavior.
...
Next (when evidence exists Ã¢â‚¬â€ never as fake features):
...
<p align="center">
  <sub>FrameGuard Ã¢â‚¬â€ make performance regressions testable the way functional regressions already are.</sub>
</p>
